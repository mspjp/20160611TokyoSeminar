...
void ::CocosAppWinRT::OpenGLESPage::Connect(int __connectionId, ::Platform::Object^ __target)
{
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::CocosAppWinRT::OpenGLESPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
